...
const P={"Grote Meren":{f:"#2D4A5E",h:"#3D6480"},"Sahel":{f:"#5A3E3E",h:"#7A5555"},"West-Afrika":{f:"#2E5249",h:"#3E7064"},"Hoorn":{f:"#5C4A38",h:"#7A634D"},"Noord-Afrika":{f:"#3A4260",h:"#4F5A80"},"Oost & Zuidelijk":{f:"#4A4259",h:"#635A75"}};
const TABS=["defence","economic","political"];
const TL={defence:"Defensie",economic:"Economie",political:"Politiek"};
const TC={defence:"#5A3E3E",economic:"#2E5249",political:"#3A4260"};
