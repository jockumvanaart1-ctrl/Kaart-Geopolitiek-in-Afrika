...
const P={"Grote Meren":{f:"#4A7C94",h:"#5E9AB2"},"Sahel":{f:"#8C6B5A",h:"#A6836F"},"West-Afrika":{f:"#4E8672",h:"#64A68E"},"Hoorn":{f:"#B08455",h:"#C89D6E"},"Noord-Afrika":{f:"#5B6E99",h:"#7286B2"},"Oost & Zuidelijk":{f:"#7B6E8E",h:"#9688A8"}};
const TABS=["defence","economic","political"];
const TL={defence:"Defensie",economic:"Economie",political:"Politiek"};
const TC={defence:"#8C6B5A",economic:"#4E8672",political:"#5B6E99"};
