...
const P={"Grote Meren":{f:"#A8895A",h:"#BFA173"},"Sahel":{f:"#A65D5D",h:"#BC7A7A"},"West-Afrika":{f:"#5D9485",h:"#76ADA0"},"Hoorn":{f:"#B8856A",h:"#CFA08A"},"Noord-Afrika":{f:"#7580A5",h:"#8F99BA"},"Oost & Zuidelijk":{f:"#8A7A9E",h:"#A394B5"}};
const TABS=["defence","economic","political"];
const TL={defence:"Defensie",economic:"Economie",political:"Politiek"};
const TC={defence:"#A65D5D",economic:"#5D9485",political:"#7580A5"};
